...
class ObjectDetection(object):
    def __init__(self, pub1, pub2, pub3):
        self._pub1 = pub1
        self._pub2 = pub2
        self._pub3 = pub3
...
if __name__ == '__main__':
    ...
    pub3 = rospy.Publisher('bridge_points', PointCloud2, queue_size=10)
    detect = ObjectDetection(pub1, pub2, pub3)
